...
class Employee{
    ...
    monthly_restrictedhours_data(){
        ...
        while (c.duration_days < c.maxdays && emphours < c.maxhours) {
            ...
            switch (empshift) {
                case 0:
                    ...
                    workdays++;
                    wage_map.set(index, c.fulltime * c.rate)
                    index++;
                ...
                case 1:
                    ...
                    workdays++;
                    wage_map.set(index, c.parttime * c.rate)
                    index++;
        ...
        console.log(wage_map)

        var sum = 0;
        wage_map.forEach(SumFunction);
        function SumFunction(item){
            sum += item;
        }

        console.log("Total Monthly Wage: " +  sum);
